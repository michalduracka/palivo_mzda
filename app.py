...
data = {
    ...
    "Petrol_Liters": [3804,2463,2598,2384,2355,2247,2218,2032,1878,1881,
                     1677,1604,1567,1554,1508,1288,1242,1235,1178,1068,
                     1036,944,931,915,900,679],
    "Diesel_Liters": [3750,2328,2466,2682,2111,2350,2020,2143,1864,1750,
                     1628,1584,1736,1482,1331,1220,1249,1176,1252,1026,
...
st.title("Koľko paliva si kúpiš za hrubú priemernú mzdu v krajinách EÚ Q1/2026")
...
for i, row in df.iterrows():
    ax.text(40, i, f'{row["Gross_Salary"]:,} €'.replace(",", " "),
